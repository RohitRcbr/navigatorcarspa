...
(function($) {
  ...
  //accrodion
  if ($(".custom-accrodion").length) {
    var accrodionGrp = $(".custom-accrodion");
        ...
        $(this)
          ...
          .on("click", function () {
            if ($(this).parent().hasClass("active") === false) {
              $(".custom-accrodion." + accrodionName)
                .find(".accrodion")
                .removeClass("active");
              $(".custom-accrodion." + accrodionName)
                .find(".accrodion")
  ...
  // main slider - start
    ...
    // Owl Carousel event listeners
    $('.main_slider').on('changed.owl.carousel', function (event) {
        var $currentItem = $('.owl-item').eq(event.item.index).find('[data-animation]');
